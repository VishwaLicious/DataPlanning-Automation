            ...
            Connection con;
               ...
               // int productCount=rd.lastrownumber();
                ...
                for(int date1=1;date1<=21;date1++) {
                	...
                	System.out.println("Verification of actuals for Bangalore City for date");
                	System.out.println("");
                	...
                	System.out.println(date);
                		...
                		String query="select  sum(x1) as y from" 
        						...
        						+ "and hub_id in ('1','2','3','4','5','6','7','8','10','12','15','46') and date(o.order_processing_date)='"+date+"' union all "
        						...
        						+ "and hub_id in ('1','2','3','4','5','6','7','8','10','12','15','46') and date(om.order_processing_date)='"+date+"') as total1 ;";
                		...
                		String sURL = "https://plan-es1.licious.app/_sql?sql="+URLEncoder.encode("select sum(order_item_quantity) from orderdataplannew where order_status='Delivered' and city_id='1' and order_processing_date='"+date+"'"); //just a string
                        
                        String Dpurl = "https://plan-es1.licious.app/_sql?sql="+URLEncoder.encode("select sum(actual_sold) from demand-plan where city_id='1' and date='"+date+"'");
...
//                      String    sURL1 = URLEncoder.encode(sURL, "UTF-8");
                          ...
                          JsonElement root = jp.parse(new InputStreamReader((InputStream) request.getContent())); //Convert the input stream to a json element
                           rootobj = root.getAsJsonObject().get("aggregations").getAsJsonObject().get("SUM(actual_sold)").getAsJsonObject().get("value"); //May be an array, may be an object.
...
//                       	   System.out.println("Not same");
				...
				public static String data_DB1() throws Throwable
				
			    {
			        ...
			        ReadData rd=new ReadData();
			            ...
			            // Dev DB Access for	 OTP
			            String url2="jdbc:mysql://metabase-replica.c5zwbgmshqe9.ap-southeast-1.rds.amazonaws.com:3306/licious";
			             
			            Connection con;
			                // Establishing DB connection for Dev
			                con=DriverManager.getConnection(url2, "marketing", "+\"4hf~`2CMAn:8=}");
			               ...
			               // int productCount=rd.lastrownumber();
			                ...
			                for(int date1=1;date1<=21;date1++) {
			                	date=rd.readDataFromExcel(excelFilePath, "Sheet1", date1, 4);
			                	System.out.println("Verification of actuals for Hyderabad City for date");
			                	System.out.println("");
			                	...
			                	System.out.println(date);
			                		...
			                		String query="select  sum(x1) as y from" 
			        						...
			        						+ "and hub_id in ('16','17','18','24','25','49','50') and date(o.order_processing_date)='"+date+"' union all "
			        						+ "select sum(quantity) as x1 from merchant_orders om, merchant_orderitems oim where om.order_id=oim.order_id and om.status='delivered'"
			        						
			        						+ "and hub_id in ('16','17','18','24','25','49','50') and date(om.order_processing_date)='"+date+"') as total1 ;";
			                        ...
			                        String Dpurl = "https://plan-es1.licious.app/_sql?sql="+URLEncoder.encode("select sum(actual_sold) from demand-plan where city_id='2' and date='"+date+"'");
...
public static String data_DB2() throws Throwable
				
			    {
			        ...
			        ReadData rd=new ReadData();
			            ...
			            // Dev DB Access for	 OTP
			            String url3="jdbc:mysql://metabase-replica.c5zwbgmshqe9.ap-southeast-1.rds.amazonaws.com:3306/licious";
			             
			            Connection con;
			                // Establishing DB connection for Dev
			                con=DriverManager.getConnection(url3, "marketing", "+\"4hf~`2CMAn:8=}");
			               ...
			               // int productCount=rd.lastrownumber();
			                ...
			                for(int date1=1;date1<=21;date1++) {
			                	date=rd.readDataFromExcel(excelFilePath, "Sheet1", date1, 4);
			                	System.out.println("Verification of actuals for NCR City for date");
			                	System.out.println("");
			                	...
			                	System.out.println(date);
			                		...
			                		String query="select  sum(x1) as y from" 
			        						...
			        						+ "and hub_id in ('19','20','21','23','26','27','28','29','30','31','32','33','47','48','51') and date(o.order_processing_date)='"+date+"' union all "
			        						+ "select sum(quantity) as x1 from merchant_orders om, merchant_orderitems oim where om.order_id=oim.order_id and om.status='delivered'"
			        						
			        						+ "and hub_id in ('19','20','21','23','26','27','28','29','30','31','32','33','47','48','51') and date(om.order_processing_date)='"+date+"') as total1 ;";
			                        ...
			                        String Dpurl = "https://plan-es1.licious.app/_sql?sql="+URLEncoder.encode("select sum(actual_sold) from demand-plan where city_id='3' and date='"+date+"'");
...
public static void main(String args[]) throws Throwable {
	...
	// Actuals updation method for Bangalore City
		data_DB();
		
	// Actuals updation method for Hyderabad City
		data_DB1();
	 
	// Actuals updation method for NCR City
		data_DB2();
