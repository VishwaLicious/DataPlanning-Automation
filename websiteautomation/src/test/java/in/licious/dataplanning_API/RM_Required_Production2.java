...
public class RM_Required_Production2 extends ElasticSearch {
	@Test
	...
	RequestSpecification request = RestAssured.given();
		...
		//String arr[]= {https://plan-es1.licious.app/_sql?sql="+URLEncoder.encode("select sum(quantity_to_produce) from production-plan-cluster where product_id in ('pr_3rkjm1v51mm') and ck_id='ck_001' and production_date='2018-10-11'};
			...
			//String arrData=null;
			String[] arrData =  new String[] {"https://plan-es1.licious.app/_sql?sql="+URLEncoder.encode("select sum(quantity_to_produce) from production-plan-cluster where product_id in ('pr_3rkjm1v51mm') and ck_id='ck_001' and production_date='2018-10-11'"),
			...
			//String equery =	arrData.getMessage();
			...
			for(int i=0;i<arrData.length;i++) {
				...
				String s22 = Arrays.toString(arrData);
